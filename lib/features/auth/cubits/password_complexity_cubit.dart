...
@lazySingleton
class PasswordComplexityCubit extends Cubit<BaseState<PasswordComplexityModel>> {
  final AuthRepository _authRepository;

  PasswordComplexityCubit(this._authRepository) : super(const BaseState.initial());
