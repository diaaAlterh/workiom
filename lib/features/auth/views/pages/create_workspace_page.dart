...
class CreateWorkspacePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final tenantAvailableCubit = getIt<TenantAvailableCubit>();
      ...
      body: Form(
        ...
        child: ListView(
          ...
          children: [
            ...
            SizedBox(height: 64),
            BlocBuilder<TenantAvailableCubit, BaseState>(
              bloc: tenantAvailableCubit,
                      ...
                      children: [
                        ...
                        Expanded(
                          child: TextFormField(
                            ...
                            onChanged: (value) {
                              debouncer.run(() {
                                tenantAvailableCubit.isTenantAvailable(
                                  tenancyName: value,
                                );
                              });
                            },
